...
In this lab, I will build a simple intelligent home monitoring system.
...
This script used OpenCV to connect to the Flask stream URL, passed each incoming frame through the `yolov8n.pt` (YOLOv8 Nano) model, and displayed the annotated frames in a new window in real-time.

## Results

### Objects Detected
During the test, the YOLO model successfully identified and drew bounding boxes around the following objects:
* Person
* Cell phone
* Bottle
* Pig
